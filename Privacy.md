...
Contributions to this project are welcomed. Contributions, suggestions or bug reports and fixes can be made by opening an issue or creating pull requests. Read the contributor's guidelines [here](https://github.com/aznoisib/Drivepad-Browser/blob/master/Contributing.md) to get started.
If you wish to contact the developer directly to share an idea, to request a feature or to make further inquiries about the functionalities and operations of the Drivepad Browser software or, you have any questions regarding this Privacy Policy or, the practices of this software, please contact the developer by opening an [issue](https://github.com/aznoisib/Drivepad-Browser/issues/new) on Github.
